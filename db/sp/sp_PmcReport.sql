...
CREATE  PROCEDURE [dbo].[SP_PmcReport]
	 @Begindate  datetime =null ,
	 @Enddate   datetime =null
	  /*
	 功能：pmc销售订单、采购、等信息跟踪报表
	 auth:jams
	 调用实例：exec  SP_PmcReport '2016-03-01 00:00:01.000','2016-03-10 23:59:59.000'
	 */
AS
BEGIN
--定义
 ...
 --取出销售订单主要信息
	...
	select  1 as 'RowType',Convert(varchar(10),a.dDate,23) as 'OrderDate',convert(varchar(10),b.dPredate,23) as 'ShipDate',
	b.cDefine22 as 'ShipWhere',b.cDefine23 as 'SapNO',
 ...
 ----插入主表信息－销售表体行信息
	insert into #tbResult(RowType,OrderDate,ShipDate,ShipWhere,SapNO,KePoNum,Custumer,
			...
			ParentInvCode,ChildInvCode,InvName,Venter,PoNum,PoQuantity,ArrQuantitySum,ArrReturSum,RdInStoreSum,RdUninSum,ArrDate,
